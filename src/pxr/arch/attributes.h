...
#define _ARCH_ENSURE_PER_LIB_INIT(T, prefix) \
    static PXR_NS::Arch_PerLibInit<T> _ARCH_CAT(prefix, __COUNTER__)
...
#   define ARCH_CONSTRUCTOR(_name, _priority)                                         \
    static void _name();                                                              \
    static const PXR_NS::Arch_ConstructorEntry _ARCH_CAT_NOEXPAND(arch_ctor_, _name) \
        __attribute__((used, section("__DATA,pxrctor"))) = {                          \
        reinterpret_cast<PXR_NS::Arch_ConstructorEntry::Type>(&_name),               \
...
#   define ARCH_DESTRUCTOR(_name, _priority)                                          \
    static void _name();                                                              \
    static const PXR_NS::Arch_ConstructorEntry _ARCH_CAT_NOEXPAND(arch_dtor_, _name) \
...
#   define ARCH_CONSTRUCTOR(_name, _priority)                                  \
    ...
    static const PXR_NS::Arch_ConstructorEntry                                 \
    ...
    _ARCH_ENSURE_PER_LIB_INIT(PXR_NS::Arch_ConstructorInit, _archCtorInit);   \
    static void _name()
