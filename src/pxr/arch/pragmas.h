...
#ifndef PXR_ARCH_PRAGMAS_H
#define PXR_ARCH_PRAGMAS_H
...
#include "./defines.h"
    ...
    #define PXR_ARCH_PRAGMA_QUALIFIER_HAS_NO_MEANING \
...
#if !defined PXR_ARCH_PRAGMA_QUALIFIER_HAS_NO_MEANING
    #define PXR_ARCH_PRAGMA_QUALIFIER_HAS_NO_MEANING
#endif
