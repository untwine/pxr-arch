...
class SpookyHash {
  public:
    ...
    static inline void Mix(
        const uint64 *data, uint64 &s0, uint64 &s1, uint64 &s2, uint64 &s3,
    ...
    static inline void EndPartial(
        uint64 &h0, uint64 &h1, uint64 &h2, uint64 &h3, uint64 &h4, uint64 &h5,
        uint64 &h6, uint64 &h7, uint64 &h8, uint64 &h9, uint64 &h10,
        uint64 &h11)
    {
        h11 += h1;
        h2 ^= h11;
    ...
    static inline void End(
        const uint64 *data, uint64 &h0, uint64 &h1, uint64 &h2, uint64 &h3,
...
void SpookyHash::Final(uint64 *hash1, uint64 *hash2)
{
    ...
    const auto *data = (const uint64 *)m_data;
