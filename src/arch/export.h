...
///  #       define FOO_API_TEMPLATE_CLASS(...) ARCH_EXPORT_TEMPLATE(class,
///  __VA_ARGS__) #       define FOO_API_TEMPLATE_STRUCT(...)
///  ARCH_EXPORT_TEMPLATE(struct, __VA_ARGS__) #   else #       define FOO_API
///  ARCH_IMPORT #       define FOO_API_TEMPLATE_CLASS(...)
///  ARCH_IMPORT_TEMPLATE(class, __VA_ARGS__) #       define
///  FOO_API_TEMPLATE_STRUCT(...) ARCH_IMPORT_TEMPLATE(struct, __VA_ARGS__) #
///  endif #   define FOO_LOCAL ARCH_HIDDEN #endif
///
///  #endif
/// \endcode
///
