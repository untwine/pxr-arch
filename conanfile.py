...
class PxrArchConan(ConanFile):
    name = "pxr-arch"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-arch"
    url = "https://github.com/untwine/pxr-arch"
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-arch"]
        self.cpp_info.libs = ["PxrArch"]
